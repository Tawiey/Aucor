...
export default function Hero() {
    ...
    return (
        <section ref={containerRef} className="relative flex min-h-[100dvh] w-full overflow-hidden px-6 pb-10 pt-24 md:px-16 md:pb-12 md:pt-28" id="home">
            ...
            {/* Content */}
            <div className="relative z-10 mx-auto flex w-[92%] max-w-7xl flex-1 flex-col md:w-[94%]">
                <div className="flex flex-1 items-center">
                    <div className="grid w-full items-center gap-10 py-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(24rem,0.95fr)] lg:gap-12 lg:py-10">
                        <div className="max-w-3xl">
                            <h1 className="hero-reveal font-sans text-[3.35rem] font-bold leading-[0.98] tracking-[-0.045em] text-ivory sm:text-[4.1rem] md:text-[5rem] xl:text-[5.8rem]">
